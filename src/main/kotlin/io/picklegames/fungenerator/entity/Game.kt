...
data class Game(
    ...
    val name: String,
    @Relationship("IS", direction = OUTGOING) val genres: MutableSet<Genre> = mutableSetOf(),
    @Relationship("CREATED", direction = INCOMING) val companies: MutableSet<Company> = mutableSetOf(),
